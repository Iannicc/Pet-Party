...
{
	private List<UtenteStandard> followers= new ArrayList<>();
	private List<UtenteStandard> followed= new ArrayList<>();
	...
	public UtenteStandard(String password, String username,ProfiloUtente profilo, boolean bloccato,List<UtenteStandard> followers,List<UtenteStandard> followed) {
